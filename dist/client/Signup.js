        ...
        React.createElement("div", { className: "bg-primary text-primary-content text-white flex items-center justify-center h-full" },
            React.createElement("div", { className: "form-control w-full max-w-lg flex items-center justify-center" },
                ...
                React.createElement("label", { className: "input-group max-w-xs mb-2" },
                    ...
                    React.createElement("input", { type: "text", placeholder: "Steve Harvey", className: `input input-bordered bg-opacity-20 w-full`, onChange: (event) => inputHandler(event.target.value, 'fullName') })),
                React.createElement("label", { className: "input-group max-w-xs mb-2" },
                    React.createElement("span", { className: "bg-secondary whitespace-pre" }, "Enneagram Type"),
                    React.createElement("select", { className: "select select-bordered w-full max-w-xs bg-opacity-20", defaultValue: "1-9", onChange: (event) => inputHandler(event.target.value, 'enneagramType') },
                ...
                React.createElement("label", { className: "input-group max-w-xs mb-2" },
                    ...
                    React.createElement("input", { type: "date", className: `input input-bordered bg-opacity-20 w-full`, onChange: (event) => inputHandler(event.target.value, 'birthday') })),
                React.createElement("label", { className: "input-group max-w-xs mb-2" },
                    React.createElement("span", { className: "bg-secondary" }, "Address"),
                    React.createElement("input", { type: "text", placeholder: "123 Sesame Street", className: `input input-bordered bg-opacity-20 w-full ${errors.zip ? 'input-error' : ''}`, onChange: (event) => inputHandler(event.target.value, 'location') })),
                React.createElement("label", { className: "input-group max-w-xs mb-2" },
                    React.createElement("span", { className: "bg-secondary whitespace-pre" }, "I am"),
                    React.createElement("select", { className: "select select-bordered w-full max-w-xs bg-opacity-20", defaultValue: "Gender", onChange: (event) => inputHandler(event.target.value, 'gender') },
                ...
                React.createElement("label", { className: "input-group max-w-xs mb-2" },
                    ...
                    React.createElement("select", { className: "select select-bordered w-full max-w-xs bg-opacity-20", defaultValue: "Gender", onChange: (event) => inputHandler(event.target.value, 'seekGender') },
                        React.createElement("option", { disabled: true }, "Gender"),
                        React.createElement("option", null, "Female"),
                        React.createElement("option", null, "Male"),
                        React.createElement("option", null, "Non-binary"))),
                React.createElement("label", { className: "input-group max-w-xs mb-2" },
                    React.createElement("span", { className: "bg-secondary" }, "Seeking"),
                    React.createElement("select", { className: "select select-bordered w-full max-w-xs bg-opacity-20", defaultValue: "Relationship Type", onChange: (event) => inputHandler(event.target.value, 'seekRelationship') },
                ...
                React.createElement("label", { className: "input-group max-w-xs mb-2" },
                    ...
                    React.createElement("input", { type: "text", placeholder: "10", className: `input input-bordered bg-opacity-20 w-1/2 ${errors.radius ? 'input-error' : ''}`, onChange: (event) => inputHandler(event.target.value, 'seekRadius') }),
                    React.createElement("span", { className: "bg-secondary w-1/4" }, "Miles")),
                React.createElement("label", { className: "input-group max-w-xs mb-2" },
                    React.createElement("span", { className: "bg-secondary" }, "Between"),
                    React.createElement("input", { type: "text", placeholder: "18", className: `input input-bordered bg-opacity-20 w-3/4 ${errors.lowAge ? 'input-error' : ''}`, onChange: (event) => inputHandler(event.target.value, 'seekAgeRangeLow') }),
                    React.createElement("span", { className: "bg-secondary" }, "and"),
                    React.createElement("input", { type: "text", placeholder: "118", className: `input input-bordered bg-opacity-20 w-full ${errors.highAge ? 'input-error' : ''}`, onChange: (event) => inputHandler(event.target.value, 'seekAgeRangeHigh') })),
